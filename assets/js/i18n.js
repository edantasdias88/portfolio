...
const translations = {
  pt: {
    hero: {
      title:
        "Crio produtos digitais que unem estratégia, design e performance.",
      description:
        "Minha missão é simplificar o complexo e criar experiências que realmente importam.",
      testimonials: [
        {
    ...
    about: {
      ...
      circleText:
        "Product Design • Design Systems • DesignOps • UX Design • UX Strategy • UI Design",
    ...
    services: {
      title:
        "Te ajudo a criar produtos e marcas do zero — ou a levar o que já existe para o próximo nível.",
      ...
      cards: [
        {
          ...
          description:
            "Projetamos experiências digitais transformadoras para todos os setores e indústrias, com foco nas metas do seu negócio, excelência na usabilidade, visual incrível e orientado a boas práticas do digital.",
          list: [
            "Sites",
            "Mobile Apps",
            "Landing Pages",
        ...
        },
        {
          ...
          description:
            "Leve seu negócio para o próximo nível com um site ou landing page incrível — e o melhor, no ar em poucos dias.",
          list: [
        ...
        },
        {
          ...
          description:
            "Conecte propósito, pessoas e negócio através de uma marca única e memorável. No digital ou off-line, seu produto precisa de uma marca sólida, que reflita a essência e os valores da sua empresa.",
          list: [
            "Logotipo",
            "Identidade Visual",
            "Manual de marca",
        ...
        },
        {
          ...
          description:
            "Obtenha um relatório completo de usabilidade, design, pontos de fricção e oportunidades de melhoria em seu website, sistema web, aplicativo ou landing page.",
          list: [
            "Design Visual",
            "Usabilidade",
            "Primeias impressões",
      ...
      steps: [
        {
          title: "Imersão",
          description:
            "Começo com um alinhamento estratégico para entender seu negócio, contexto e objetivos. Nessa etapa, defino o escopo e conduzo pesquisas que fundamentam decisões ao longo de todo o projeto.",
        },
        {
          title: "Estruturação",
          description:
            "Com base nos insights levantados, desenvolvo wireframes (quando necessário) e fluxos de navegação, organizando a informação de forma clara e priorizando usabilidade e eficiência.",
        },
        {
          title: "Design de Interface",
          description:
            "Aqui é onde a solução ganha forma. Traduzo estratégia e conceito em uma experiência visual consistente, funcional e intuitiva, sempre alinhada à identidade da sua marca.",
        },
        {
          title: "Entrega & Handoff",
          description:
            "Com tudo validado, entrego os materiais organizados e documentados, prontos para desenvolvimento — garantindo clareza, qualidade e aderência aos prazos.",
        },
      ],
    },
    work: {
      ...
      items: [
        {
          ...
          description:
            "Entregamos sempre o melhor, com máxima velocidade e qualidade, respeitando rigorosamente os prazos estabelecidos.",
        },
        {
          title: "Comunicação facilitada",
          description:
            "Durante o projeto, fico à disposição para esclarecer dúvidas, receber sugestões e realizar tantas reuniões quanto se fizerem necessárias.",
        },
        {
          title: "Equipe enxuta, resultado máximo",
          description:
            "Embora trabalhe de forma independente, conto com outros profissionais experientes de confiança para colaborar nos projetos — sem custo adicional para você.",
        },
        {
          title: "Garantia de excelência",
          description:
            "Não paro de trabalhar até que o projeto esteja plenamente de acordo com suas expectativas e seja aprovado por você.",
        },
      ],
    },
  },
  ...
  en: {
    hero: {
      title:
        "I design digital products that combine strategy, design and performance.",
      description:
        "My mission is to simplify complexity and create experiences that truly matter.",
      testimonials: [
        {
    ...
    about: {
      title: "Edilson Dantas Dias",
      description:
        "I believe design goes far beyond aesthetics; it is a strategic tool capable of simplifying complex problems, accelerating processes, and creating experiences that truly connect people and businesses.",
    ...
    services: {
      title:
        "I help you create products and brands from scratch — or take what already exists to the next level.",
      ...
      cards: [
        {
          ...
          description:
            "We design transformative digital experiences across industries, focusing on your business goals, usability excellence, and best practices.",
          list: [
            "Websites",
            "Mobile Apps",
            "Landing Pages",
        ...
        },
        {
          ...
          description:
            "Take your business to the next level with a high-performance website or landing page.",
          list: [
        ...
        },
        {
          ...
          description:
            "Build a strong and memorable brand that connects purpose, people and business.",
          list: ["Logo", "Visual identity", "Brand guidelines", "Rebranding"],
        },
        {
          title: "UI/UX Audit",
          subtitle: "End-to-end product analysis",
          description:
            "Get a complete usability and design report with improvement opportunities.",
          list: [
            "Visual design",
            "Usability",
            "First impressions",
      ...
      steps: [
        {
          ...
          description:
            "I start with a strategic alignment to understand your business, context, and goals. At this stage, I define the scope and conduct research to support decisions throughout the project.",
        },
        {
          title: "Structuring",
          description:
            "Based on the insights gathered, I create wireframes (when needed) and navigation flows, organizing information clearly while prioritizing usability and efficiency.",
        },
        {
          title: "Interface Design",
          description:
            "This is where the solution takes shape. I translate strategy and concepts into a consistent, functional, and intuitive visual experience, always aligned with your brand.",
        },
        {
          title: "Delivery & Handoff",
          description:
            "Once everything is validated, I deliver organized and well-documented assets, ready for development — ensuring clarity, quality, and alignment with deadlines.",
        },
      ],
    },
    work: {
      ...
      items: [
        {
          ...
          description:
            "We always deliver the best with speed and quality, strictly respecting deadlines.",
        },
        {
          title: "Clear communication",
          description:
            "During the project, I’m available to clarify doubts, receive feedback, and meet whenever necessary.",
        },
        {
          title: "Lean team, maximum results",
          description:
            "Although I work independently, I collaborate with trusted professionals when needed — at no extra cost to you.",
        },
        {
          title: "Excellence guarantee",
          description:
            "I keep working until the project fully meets your expectations and gets your approval.",
        },
      ],
    },
  },
...
function renderServices() {
  ...
  cards.forEach((card, index) => {
    ...
    const deliverable = card.querySelector(
      ".services_right .services_header span",
    );
